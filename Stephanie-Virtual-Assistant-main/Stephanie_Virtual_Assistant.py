...
def assistant(command):
    ...
    if 'open reddit' in command:
        ...
        reg_ex = re.search('weather at(.+)', command)
        if reg_ex:
            domain = reg_ex.group(1)
            url = 'https://www.theweathernetwork.com/ca/search?q=' + domain
            webbrowser.open(url)
            print('Done!')
        else:
            pass
    ...
    elif 'start google chrome' in command:
        ...
        if reg_ex:
            domain = reg_ex.group(1)
            url = 'https://wynk.in/music/detailsearch/' + domain
            webbrowser.open(url)
            print('Done!')
        else:
            pass
